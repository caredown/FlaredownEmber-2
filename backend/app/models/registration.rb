class Registration
  ...
  with_options unless: Proc.new { |object| object.is_client.present? } do |client|
  ...
  def initialize(params)
    ...
    @is_client = @user_params["is_client"]
  ...
  def permitted(params)
    params.require(:registration).permit(
      :email, :password, :password_confirmation, :screen_name, :captcha_response, :is_client
    )
  end
